  ...
  const card = (
    <React.Fragment>
      <CardContent sx={{maxWidth:688,}}>
        ...
        <Typography sx={{fontSize:19,mt:3,}}>
        ...
        <Typography sx={{fontSize:14,fontWeight:"bold",mt:2,display:'flex',color:'#0A56A3',ml:3,mt:4,alignItems:'center'}} variant="h6">
        <ArrowBackIcon sx={{mr:1,fontSize:16}}/>
        BACK
        </Typography>
        <Box sx={{mt:5,display:'flex',justifyContent:'space-between'}}>
            <Button variant="outlined" sx={{borderRadius:'20px',fontWeight:'bold',border:2,borderColor:"#0A56A3",color:"#0A56A3"}}>NOT NOW</Button>
            <Button variant="contained" sx={{borderRadius:'20px',fontWeight:'bold'}} style={{backgroundColor:"#0A56A3"}}>SEND</Button>
        </Box>
      </CardContent>
    </React.Fragment>
  );
